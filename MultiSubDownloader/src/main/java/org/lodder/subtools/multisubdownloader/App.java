...
public class App {
			...
			if (line.hasOption("help")) {
				...
				if (line.hasOption("importpreferences")) {
					...
					if (line.hasOption("language")) {
						...
						Logger.instance
								.log("No language given using default: 'nl' ");
	...
	public static Options getCLIOptions() {
		...
		options.addOption("R", "recursive", false,
				"search every folder found in the folder");
		...
		options.addOption("force", false,
				"force to overwrite the subtitle on disk");
		options.addOption("folder", false, "folder to search");
		options.addOption("downloadall", false,
				"Download all found subs using '-v1' system ");
		options.addOption("updatefromonlinemapping", false,
				"Update with the Mappings from online");
